...
public class CopyFileActionTest {
    ...
    //Test 1: Verify if a file has been succesfully copied from a folder to another one
    @Test
    void testExecuteCopiesFileSuccessfully() throws IOException {
        ...
        File sourceFile = Files.createFile(sourceDir.resolve("testCopy.txt")).toFile();
